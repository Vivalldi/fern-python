...
class FernIr:
    def __init__(self, *, environment: str, timeout: typing.Optional[float] = 60):
        ...
        self.ai = AiClient(environment=self._environment, client=self._client_wrapper)
...
class AsyncFernIr:
    def __init__(self, *, environment: str, timeout: typing.Optional[float] = 60):
        ...
        self.ai = AsyncAiClient(environment=self._environment, client=self._client_wrapper)
