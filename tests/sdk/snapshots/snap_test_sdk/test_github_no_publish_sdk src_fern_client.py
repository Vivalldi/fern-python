...
class FernIr:
    def __init__(self, *, environment: str, timeout: typing.Optional[float] = 60):
        ...
        self.movie = MovieClient(environment=self._environment, client=self._client_wrapper)
...
class AsyncFernIr:
    def __init__(self, *, environment: str, timeout: typing.Optional[float] = 60):
        ...
        self.movie = AsyncMovieClient(environment=self._environment, client=self._client_wrapper)
